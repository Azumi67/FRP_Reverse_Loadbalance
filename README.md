...
-  داخل Host setting برای کانفیگ سرور مرکزی، دو تا add host را میزنم و ایپی دو تا نود را میدم و پورت ها هم 8082 و 8083 میذارم و بعد داخل core setting من 3 کانفیگ با بورت مختلف درست میکنم 
...
- قبل اینکه تانل را آغاز کنیم، از داخل Host setting، تمامی ایپی ها را به ایپی سرور ایران تغییر میدیم و همان پورت ها هم استفاده خواهم کرد. میشه پورت یکسان 443 هم استفاده کرد اما اگر از تک پورت استفااده کنیم، تمام کانفیگ ها، ایپی سرور مرکزی را نشان میدهند. (من زیاد نتونستم تست کنم)
- پس با همون پورت های متفاوت 8081 و 8082 و 8083 پیش میرویم که ایپی ها هم متفائت باشد.
...
- امکان استفاده از تک پورت میباشد اما مشکل اینجاست که اگر تک پورت استفاده کنید تمام کانکشن های شما ایپی سرور مرکزی رو نشون میدن و میخواهیم بدون استفاده از کلود یا روتینگ، بتونیم از طریق FRP اینکار را انجام دهیم. 
