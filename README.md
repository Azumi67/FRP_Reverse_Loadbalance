...
-  پورت دیفالت استفاده شده در FRP، پورت 8443 میباشد. این پورت را نمیتوانید استفاده کنید.(تنها در TCP ولی در KCP و QUIC امکان انتخاب دارید)
