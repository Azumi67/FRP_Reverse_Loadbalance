...
- من 3 تا کانفیگ vmess با پورت های مختلف درست کردم اگر از داخل Host setting فقط اینکار را انجام دهم باز هم پس از تانل FRP، تمام 3 تا کانفیگ ما، ایپی های یکسان را نشان میدهند. من از داخل Core Setting دو تا کانفیگ دیگر با پورت های مختلف و تگ های مختلف ایجاد میکنم. به این صورت : 
