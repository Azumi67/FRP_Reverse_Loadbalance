...
- 
- قبل اینکه داخل core setting من 3 کانفیگ با بورت مختلف درست کنم ، قبلش داخل Host setting برای کانفیگ سرور مرکزی، دو با add host را میزنم و ایپی دو تا نود را میدم و پورت ها هم 8082 و 8083 میذارم.
- سپس من 3 تا کانفیگ vmess با پورت های مختلف درست میکنم اگر از داخل Host setting فقط اینکار را انجام دهم باز هم پس از تانل FRP، تمام 3 تا کانفیگ ما، ایپی های یکسان را نشان میدهند. من از داخل Core Setting دو تا کانفیگ دیگر با پورت های مختلف و تگ های مختلف ایجاد میکنم. به این صورت : 
...
- قبل اینکه تانل را آغاز کنیم، از داخل Host setting، تمامی ایپی ها را به ایپی سرور ایران تغییر میدیم و همان پورت ها هم استفاده خواهم کرد. میشه پورت یکسان 443 هم استفاده کرد اما تمام کانفیگ ها، ایپی سرور مرکزی را نشان میدهند. (من زیاد نتونستم تست کنم)
- پس با همون پورت های قدیم 8081 و 8082 و 8083 پیش میرویم.
