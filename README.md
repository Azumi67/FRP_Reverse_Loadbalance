...
- قبل اینکه تانل را آغاز کنیم، از داخل Host setting، تمامی ایپی ها را به ایپی سرور ایران تغییر میدیم و همان پورت ها هم استفاده خواهم کرد. میشه پورت یکسان 443 هم استفاده کرد اما اگر از تک پورت استفاده کنیم، تمام کانفیگ ها، ایپی سرور مرکزی را نشان میدهند. (من زیاد نتونستم تست کنم)
